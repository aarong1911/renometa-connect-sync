...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: "google-ads", name: "Google Ads", vendor: "Google", description: "Connect Google Ads to capture leads, track campaign performance, and automate follow-up.", connectMethod: "oauth", category: "ads-leads", syncBadges: ["Leads", "Campaigns", "Reporting"], automations: ["Instant SMS to new leads", "Send booking link automatically"], connected: false },
