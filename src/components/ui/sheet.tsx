...
interface SheetContentProps
  ...
  /** Set false to omit the built-in top-right X — use when a custom header already owns close affordances (Escape / outside-click / browser back still work via Radix Dialog regardless). Defaults to true so existing Sheet usages are unaffected. */
...
>(({ side = "right", className, children, showCloseButton = true, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content ref={ref} data-mobile-sheet-side={side} className={cn(sheetVariants({ side }), className)} {...props}>
      {showCloseButton && (
